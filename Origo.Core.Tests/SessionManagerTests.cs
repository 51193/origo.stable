...
public class SessionManagerTests
{
    ...
    [Fact]
    public void ProcessBackgroundSessions_OnlySynced_SessionsAreProcessed()
    {
        var (ctx, _) = CreateContext();
        ...
        ctx.SessionManager.ProcessBackgroundSessions(0.016);
    }
    ...
    [Fact]
    public void BackgroundLevelIds_WellKnownKey_Exists()
    {
        Assert.Equal("origo.background_level_ids", WellKnownKeys.BackgroundLevelIds);
    }
    ...
    private static (SndContext ctx, TestFileSystem fs) CreateContext()
    {
        ...
        var progressRun = ctx.RunFactory.CreateProgressRun("001", new Blackboard.Blackboard());
