...
public class SessionDecouplingTests
{
    ...
    private sealed class TrackingSaveStorageService : ISaveStorageService
    {
        ...
        public void WriteSavePayloadToCurrentThenSnapshot(
            SaveGamePayload payload, string baseSaveId, string newSaveId,
            Origo.Core.Abstractions.Logging.ILogger logger) =>
            _inner.WriteSavePayloadToCurrentThenSnapshot(payload, baseSaveId, newSaveId, logger);
        ...
        public void SnapshotCurrentToSave(string baseSaveId, string newSaveId) =>
            _inner.SnapshotCurrentToSave(baseSaveId, newSaveId);
